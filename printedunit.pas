...
procedure Tprinted.canvasPaint(Sender: TObject);
var
   loop : integer;
   count : integer;
   x : integer;
...
procedure Tprinted.Panel3Click(Sender: TObject);
begin
Close;
end;

procedure Tprinted.printClick(Sender: TObject);
begin
text.Enabled := print.Checked;
end;

procedure Tprinted.Panel4Click(Sender: TObject);
begin
if(print.Checked) then MainForm.Child.Add('echo ' +text.Text)
else MainForm.Child.Add('echo.');

Panel5Click(Panel4);
end;

procedure Tprinted.Panel5Click(Sender: TObject);
begin
text.Clear;
print.Checked := true;
blank.Checked := false;
