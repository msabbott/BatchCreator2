...
uses
  ...
  ExtCtrls, TB97, StdCtrls, Main, ComboBox97;
...
type
  TOpenForm = class(TForm)
    ...
    pages: TNotebook;
    Panel3: TPanel;
    docbut: TToolbarButton97;
    recbut: TToolbarButton97;
    favbut: TToolbarButton97;
    Panel1: TPanel;
    Panel4: TPanel;
    canvas: TPaintBox;
    Panel5: TPanel;
    ...
    procedure docbutClick(Sender: TObject);
    procedure recbutClick(Sender: TObject);
    procedure favbutClick(Sender: TObject);
    procedure canvas3Paint(Sender: TObject);
  private
...
procedure TOpenForm.canvasPaint(Sender: TObject);
var
   loop : integer;
   count : integer;
   x : integer;
...
procedure TOpenForm.canvas2Paint(Sender: TObject);
var
   loop : integer;
   count : integer;
   x : integer;
...
procedure TOpenForm.docbutClick(Sender: TObject);
begin
pages.ActivePage := 'docs';
end;

procedure TOpenForm.recbutClick(Sender: TObject);
begin
pages.ActivePage := 'recent';
end;

procedure TOpenForm.favbutClick(Sender: TObject);
begin
pages.ActivePage := 'fav';
end;

procedure TOpenForm.canvas3Paint(Sender: TObject);
var
   loop : integer;
   count : integer;
   x : integer;
