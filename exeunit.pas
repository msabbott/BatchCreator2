...
procedure Texecute.FormPaint(Sender: TObject);
var
   loop : integer;
   count : integer;
   x : integer;
...
procedure Texecute.startClick(Sender: TObject);
begin
call.Enabled := not start.Checked;
end;

procedure Texecute.Panel14Click(Sender: TObject);
begin
call.Enabled := true;
call.Checked := true;
start.Checked := false;
...
procedure Texecute.Panel3Click(Sender: TObject);
begin
Close;
end;

procedure Texecute.Panel5Click(Sender: TObject);
begin
...
procedure Texecute.Panel13Click(Sender: TObject);
var
   cmdline : string;
begin
if (start.Checked = true) then
   begin
        cmdline := 'start ' + filename.Text;
   end

   else begin
if (call.Checked = true) then
   begin
        cmdline := 'call ' + filename.Text;
   end
   else cmdline := filename.Text;
  end;
...
procedure Texecute.canvasPaint(Sender: TObject);
var
   loop : integer;
   count : integer;
   x : integer;
