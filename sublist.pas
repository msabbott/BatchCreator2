...
procedure Tsublistform.canvasPaint(Sender: TObject);
var
   loop : integer;
   count : integer;
   x : integer;
...
procedure Tsublistform.Panel3Click(Sender: TObject);
begin
Close;
end;

procedure Tsublistform.FormShow(Sender: TObject);
begin
Title.Caption := ' Project: '+MainForm.Child.Caption;
end;
