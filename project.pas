...
procedure Tproj.canvasPaint(Sender: TObject);
var
   loop : integer;
   count : integer;
   x : integer;
...
procedure Tproj.Panel3Click(Sender: TObject);
begin
Close;
end;

procedure Tproj.FormShow(Sender: TObject);
begin
list.Lines.Clear;
list.Lines.AddStrings(MainForm.Child.Project.Items);
end;
